...
namespace CapaEntidad
{
    public class Asignacion_M_T
    {
        ...
        public string TproNombre { get; set; }
        ...
        public double? Precio_Credito { get; set; }
        ...
        public double? MAQ_DEVPORCENTAJE { get; set; }
        ...
        public string SistemaTitulo { get; set; }
        public string PosicionBilletero { get; set; }
        public int? con_sorteo { get; set; }
        public int? Block { get; set; }
        public int? CPromoBonus { get; set; }
        public int? CPromoTickets { get; set; }
