...
{
    [seguridad]
    public class MIRepuestoController : Controller {

        private MI_RepuestoBL repuestoBL = new MI_RepuestoBL();
        public ActionResult ListadoRepuesto() {
            return View("~/Views/MaquinasInoperativas/ListadoRepuesto.cshtml");
        }

        [seguridad(false)]
        [HttpPost]
        public JsonResult ListarRepuestoJson() {
            var errormensaje = "";
            var lista = new List<MI_RepuestoEntidad>();

            try {

                lista = repuestoBL.RepuestoListadoCompletoJson();
        ...
        [seguridad(false)]
        [HttpPost]
        public JsonResult ListarRepuestoActiveJson() {
            var errormensaje = "";
            ...
            try {
                ...
                lista = repuestoBL.RepuestoListadoActiveJson();
                respuesta = true;
        ...
        [HttpPost]
        public JsonResult ListarRepuestoxCategoriaJson(int cod) {
            var errormensaje = "";
            bool respuesta = false;
            var lista = new List<MI_RepuestoEntidad>();
            ...
            try {
                ...
                lista = repuestoBL.RepuestoListadoxCategoriaJson(cod);
                respuesta = true;
        ...
        [HttpPost]
        public JsonResult ListarRepuestoCodJson(int codRepuesto) {
            var errormensaje = "";
            bool respuesta = false;
            ...
            try {
                ...
                item = repuestoBL.RepuestoCodObtenerJson(codRepuesto);
                respuesta = true;
        ...
        [HttpPost]
        public ActionResult RepuestoEditarJson(MI_RepuestoEntidad repuesto) {
            var errormensaje = "";
            bool respuestaConsulta = false;
            repuesto.FechaModificacion = DateTime.Now;
            try {
                respuestaConsulta = repuestoBL.RepuestoEditarJson(repuesto);

                if(respuestaConsulta) {

                    errormensaje = "Registro de Repuesto Actualizado Correctamente";
                } else {
                    errormensaje = "Error al Actualizar Repuesto , LLame Administrador";
        ...
        [HttpPost]
        public ActionResult RepuestoGuardarJson(MI_RepuestoEntidad repuesto) {
            var errormensaje = "";
            ...
            try {
                ...
                repuesto.FechaModificacion = DateTime.Now;
                repuesto.CodUsuario = usuario.UsuarioNombre;

                respuestaConsulta = repuestoBL.RepuestoInsertarJson(repuesto);

                if(respuestaConsulta > 0) {
                    respuesta = true;
                    errormensaje = "Registro de Repuesto Guardado Correctamente";
                } else {
                    errormensaje = "Error al Crear Repuesto , LLame Administrador";
                    respuesta = false;
                }
            } catch(Exception exp) {
                errormensaje = exp.Message + " ,Llame Administrador";
        ...
        [HttpPost]
        public ActionResult RepuestoEliminarJson(int cod) {
            var errormensaje = "";
            bool respuesta = false;

            try {
                respuesta = repuestoBL.RepuestoEliminarJson(cod);
                if(respuesta) {
                    respuesta = true;
                    errormensaje = "Se quitó el Repuesto Correctamente";
                } else {
                    errormensaje = "Error al Quitar el Repuesto , LLame Administrador";
                    respuesta = false;
                }
            } catch(Exception exp) {
                errormensaje = exp.Message + " ,Llame Administrador";
        ...
        [HttpPost]
        public ActionResult RepuestoDescargarExcelJson() {
            ...
            try {
                ...
                if(lista.Count > 0) {
                    ...
                    var workSheet = excel.Workbook.Worksheets.Add("Repuesto");
                    ...
                    workSheet.Cells[3, 8].Value = "Categoria Repuesto";
                    ...
                    foreach(var registro in lista) {
                        ...
                        workSheet.Cells[recordIndex, 2].Value = registro.CodRepuesto;
                        ...
                        workSheet.Cells[recordIndex, 8].Value = registro.NombreCategoriaRepuesto;
                    ...
                    */
                    ...
                    excelName = "Repuesto_" + fecha + ".xlsx";
