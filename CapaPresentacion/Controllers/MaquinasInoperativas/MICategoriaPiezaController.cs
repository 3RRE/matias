...
{
    [seguridad]
    public class MICategoriaPiezaController : Controller
    {
        private MI_PiezaBL piezaBL = new MI_PiezaBL();
        private MI_CategoriaPiezaBL categoriaPiezaBL = new MI_CategoriaPiezaBL();
        public ActionResult ListadoCategoriaPieza() {
            return View("~/Views/MaquinasInoperativas/ListadoCategoriaPieza.cshtml");
        }

        [seguridad(false)]
        [HttpPost]
        public JsonResult ListarCategoriaPiezaJson() {
            var errormensaje = "";
            var lista = new List<MI_CategoriaPiezaEntidad>();

            try {

                lista = categoriaPiezaBL.CategoriaPiezaListadoCompletoJson();
        ...
        [seguridad(false)]
        [HttpPost]
        public JsonResult ListarCategoriaPiezaActiveJson() {
            var errormensaje = "";
            ...
            try {
                ...
                lista = categoriaPiezaBL.CategoriaPiezaListadoActiveJson();
                respuesta = true;
        ...
        [HttpPost]
        public JsonResult ListarCategoriaPiezaCodJson(int codCategoriaPieza) {
            var errormensaje = "";
            bool respuesta = false;
            ...
            try {
                ...
                item = categoriaPiezaBL.CategoriaPiezaCodObtenerJson(codCategoriaPieza);
                respuesta = true;
        ...
        [HttpPost]
        public ActionResult CategoriaPiezaEditarJson(MI_CategoriaPiezaEntidad categoriaPieza) {
            var errormensaje = "";
            bool respuestaConsulta = false;
            categoriaPieza.FechaModificacion = DateTime.Now;
            try {
                respuestaConsulta = categoriaPiezaBL.CategoriaPiezaEditarJson(categoriaPieza);
        ...
        [HttpPost]
        public ActionResult CategoriaPiezaGuardarJson(MI_CategoriaPiezaEntidad categoriaPieza) {
            var errormensaje = "";
            Int64 respuestaConsulta = 0;
            bool respuesta = false;
            try {
                SEG_UsuarioEntidad usuario = (SEG_UsuarioEntidad)Session["usuario"];
                categoriaPieza.FechaRegistro = DateTime.Now;
                categoriaPieza.FechaModificacion = DateTime.Now;
                categoriaPieza.CodUsuario = usuario.UsuarioNombre;

                respuestaConsulta = categoriaPiezaBL.CategoriaPiezaInsertarJson(categoriaPieza);
        ...
        [HttpPost]
        public ActionResult CategoriaPiezaEliminarJson(int cod) {
            var errormensaje = "";
            bool respuesta = false;

            
            List<MI_PiezaEntidad> lista = piezaBL.PiezaListadoCompletoJson();

            foreach(var item in lista) {
                if(item.CodCategoriaPieza == cod) {
                    errormensaje = "La Categoria Pieza se encuentra actualmente asignada.";
                    respuesta = false;
                    return Json(new { respuesta = respuesta, mensaje = errormensaje });
                }
            }
            ...
            try {
                respuesta = categoriaPiezaBL.CategoriaPiezaEliminarJson(cod);
                if(respuesta) {
                    respuesta = true;
        ...
        [HttpPost]
        public ActionResult CategoriaPiezaDescargarExcelJson() {
            ...
            try {
                ...
                if(lista.Count > 0) {
                    ...
                    var workSheet = excel.Workbook.Worksheets.Add("CategoriaPieza");
                    ...
                    foreach(var registro in lista) {
                        ...
                        workSheet.Cells[recordIndex, 2].Value = registro.CodCategoriaPieza;
                    ...
                    */
                    ...
                    excelName = "CategoriaPieza_" + fecha + ".xlsx";
