...
namespace CapaPresentacion.Controllers.Drive
{
    [seguridad(false)]
    public class DriveController : Controller
    {
        ...
        [seguridad(false)]
        [HttpPost]
        public ActionResult SubirImagenDrive(string imagen)
        {
            ...
            string fileId = UploadBase64FileInFolder(service, imagen);
            return Json(new { data = fileId });
        }
        [seguridad(false)]
        [HttpPost]
        public ActionResult DescargarImagenDrive(string imagenid)
        {
            UserCredential credential;
            ...
            string respuesta = DownloadFile(service, imagenid);
            return Json(new { data = respuesta });
        }
        private static string UploadBase64FileInFolder(DriveService service, string base64string)
        {
            ...
            listaParent.Add("1sb2bLuQSQz4NHrMnb8Kc8ImlfXUbsLtf");
            //metadata
