$(document).ready(function () {
    ...
    $.when(VistaAuditoria("Usuario/UsuarioRegistroVista", "VISTA", 1, "#frmRegistroUsuario", 3)).then(function (response, textStatus) {
        dataAuditoria(0, "#frmRegistroUsuario", 3);
    });
                ...
                if (response) {
                    if (response.respuesta) {
                        ...
                        if (data.UsuarioID > 0) {
                            ...
                            $.when(dataAuditoria(1, "#frmRegistroUsuario", 3, "Usuario/UsuarioActualizarIdJason", "ACTUALIZAR USUARIO")).then(function (response, textStatus) {
