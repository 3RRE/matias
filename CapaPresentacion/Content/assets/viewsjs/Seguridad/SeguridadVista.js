$(document).ready(function () {
    ...
    llenarSelect(basePath + "RolUsuario/ListadoRolUsuario", {}, "cboRol_", "WEB_RolID", "WEB_RolNombre", rolid);
    //permisosMenuDis(0);
...
function ListadoRolestab() {
    var url = basePath + "Seguridad/ListadoRolesSeguridadPermiso";
    $.ajax({
        url: url,
        type: "POST",
        data: JSON.stringify({}),
        ...
        success: function (response) {
            ...
            if (roles) {
                ...
                $.each(roles, function (index, value) {
                    $("#listaRoles").append('<li class="" data-id="' + value.WEB_RolID + '">' + '<a href="#">' + value.WEB_RolNombre + '</a>' + '</li>');
                });
