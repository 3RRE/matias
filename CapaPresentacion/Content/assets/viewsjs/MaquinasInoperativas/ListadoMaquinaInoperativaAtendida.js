...
function ListarMaquinaInoperativa() {
    var url = basePath + "MIMaquinaInoperativa/ListarMaquinaInoperativaAtendidaJson";
                    ...
                    },
                    {
                        ...
                        "render": function (o, type, oData) {
                            ...
                            if (oData.Estado == 1) {
                                ...
                                return
                                //`<button type="button" class="btn btn-xs btn-warning btnDetalle" data-id="${o}">EDITAR</i></button> 
