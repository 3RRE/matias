$(document).ready(function () {
    ...
    VistaAuditoria("MIMaquinaInoperativa/ListarMaquinaInoperativaAtendidaInoperativa", "VISTA", 0, "", 3);

    $(document).on("click", ".btnAtender", function () {
        let id = $(this).data("id");
        let url = basePath + "MIMaquinaInoperativa/AtenderSolicitudMaquinaInoperativaVista/" + id;
