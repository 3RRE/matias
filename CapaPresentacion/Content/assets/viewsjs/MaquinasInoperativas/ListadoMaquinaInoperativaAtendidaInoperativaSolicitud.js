$(document).ready(function () {
    ...
    VistaAuditoria("MIMaquinaInoperativa/ListarMaquinaInoperativaAtendidaInoperativaSolicitud", "VISTA", 0, "", 3);

    $(document).on("click", ".btnDetalles", function () {
        let id = $(this).data("id");
        let url = basePath + "MIMaquinaInoperativa/AprobarSolicitudMaquinaInoperativaVista/" + id;
    ...
    $(document).on("click", "#btnExcel", function () {
        $.ajax({
            type: "POST",
            cache: false,
            url: basePath + "MIMaquinaInoperativa/ListarMaquinaInoperativaAtendidaInoperativaSolicitudExcelJson",
...
function ListarMaquinaInoperativaAtendidaOperativa() {
    var url = basePath + "MIMaquinaInoperativa/ListarMaquinaInoperativaAtendidaInoperativaSolicitudJson";
            ...
            objetodatatable = $("#tableMaquinaInoperativa").DataTable({
                ...
                columns: [
                    ...
                    { data: "NombreUsuarioCreado", title: "Usuario" },
                    {
                        ...
                        "render": function (o) {
                            var estado = "EN ESPERA SOLICITUD";
                            var css = "btn-warning";
                            //if (o == 3) {
                            //    estado = "ATENDIDO"
                            //    css = "btn-danger";
