$(document).ready(function(){
    $("#Id").val(tipoOcurrencia.Id)
    $("#Nombre").val(tipoOcurrencia.Nombre)
    $("#Descripcion").val(tipoOcurrencia.Descripcion)
    ...
    $(document).on('click','.btnGuardar',function(e){
        ...
        if(validar.isValid()){
            ...
            $.ajax({
                url: basePath + "Ocurrencias/EditarTipoOcurrenciaJson",
                type: "POST",
                ...
                success: function (response) {
                    if(response.respuesta){
                        ...
                        setTimeout(function () {
                            window.location.href=basePath + "Ocurrencias/EditarTipoOcurrencia/" + tipoOcurrencia.Id;;
                        }, 2000);
                    }else{
