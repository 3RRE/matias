...
function ListarMaquinaInoperativaCreadas() {
        ...
        success: function (response) {
            ...
            objetodatatable = $("#tableMaquinaInoperativa").DataTable({
                ...
                columns: [
                    ...
                    { data: "NombreUsuarioCreado", title: "Usuario Creación" },
                    {
