...
function buscarTicket() {
    ...
    var url = ipPublicaG + "/servicio/ConsultaTicketRegistradoMovAuxiliarXMaqAlternoAndItemCaja?maqAlterno=" + $("#maqAlterno").val() + "&itemCaja=" + $("#itemCaja").val();
    
    if ($("#maqAlterno").val() =="") {
        toastr.error("Ingrese Numero de Máquina Alterna.");
    }
    if ($("#itemCaja").val() == "") {
        toastr.error("Ingrese Número de Item.")
    }
    console.log(url);
    $.ajax({
        type: "POST",
        cache: false,
        url: basePath +"CallCenter/ConsultaTicketRegistradoMovAuxiliarXMaqAlternoAndItemCajaJson",
        ...
        success: function (response) {             
            ...
            objetodatatable = $("#table").DataTable({
                ...
                columns: [
                    ...
                    { data: "hora_registro", title: "hora_registro","render": function (value) {
