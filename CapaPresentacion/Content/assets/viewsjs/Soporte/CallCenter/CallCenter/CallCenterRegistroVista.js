        ...
        success: function (result) {
            ...
            if (lista.length > 0) {
                $.each(lista, function (indice, valor) {
                    if (valor['TipoPozo'] == 1) { $('#txtPSPozoActual').val(valor['Actual']); $('#hid_cod_det_prog_sup').val(valor['DetalleProgresivoID']); }
                    if (valor['TipoPozo'] == 2) { $('#txtPMPozoActual').val(valor['Actual']); $('#hid_cod_det_prog_med').val(valor['DetalleProgresivoID']); }
                    if (valor['TipoPozo'] == 3) { $('#txtPIPozoActual').val(valor['Actual']); $('#hid_cod_det_prog_inf').val(valor['DetalleProgresivoID']); }
                });
