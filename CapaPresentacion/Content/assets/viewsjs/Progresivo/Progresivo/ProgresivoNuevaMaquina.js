$(document).ready(function () {
    ...
    $("#btnListar").click(function () {
        window.location.href = basePath + "Progresivo/ProgresivoListadoMaquina";
    });
    ...
    $('#btnGuardar').click(function () {
        ...
        if (validar.isValid()) {
            ...
            if($("#consultaVpn").val().toLowerCase()=='true'){
                uriConsulta+="Progresivo/ConsultarGuardarMaquinaProgresivoVpn"
                datasend={
                    parametros:dataForm,
                    urlPrivada:$("#urlPrivada").val()+"/servicio/GrabarMaquina?codProgresivo=" + $("#codProgresivo").val(),
                    urlPublica:$("#urlPublica").val()+"/servicio/GrabarMaquinaVpn"
                }
            }
            else{
                  //
                var url_ = $("#url_sala").val() + "/servicio/GrabarMaquina?codProgresivo=" + $("#codProgresivo").val();
                uriConsulta+="Progresivo/ConsultarGuardarMaquinaProgresivo"
                datasend={
                    parametros:dataForm,
                    url:url_
                }
                ...
                confirm: function () {
                    ajaxhr = $.ajax({
                        ...
                        success: function (response) {
                            setCookie("datainicial", "");
                            // $.when(dataAuditoria(1, "#frmMaquinaProgresivo", 3, "Progresivo/ConsultarGuardarMaquinaProgresivo", "NUEVA MAQUINA PROGRESIVO")).then(function (response, textStatus) {
                            //     enviarDataPost(uriConsulta, dataForm, false, false, redirectUrl, true);
                            // });
                            var estado = response.data;
                            console.log(estado)
...
function ObtenerListaMarcaMaquina() {
    ...
    if($("#consultaVpn").val().toLowerCase()=='true'){
        ...
        dataForm={
            url:$("#url_sala").val() + "/servicio/getMarcas?codProgresivo=" + $("#codProgresivo").val()
        }
...
function ObtenerModeloMaquina(id) {
    ...
    if($("#consultaVpn").val().toLowerCase()=='true'){
        dataForm={
            urlPrivada:$("#urlPrivada").val()+"/servicio/ListarModelosidmarca?codProgresivo=" + $("#codProgresivo").val() + "&idmarca=" + id,
        ...
        dataForm={
            url:$("#url_sala").val() + "/servicio/ListarModelosidmarca?codProgresivo=" + $("#codProgresivo").val() + "&idmarca=" + id
        }
...
function ObtenerJuegoMaquina() {
    ...
    var url_ = $("#url_sala").val() + "/servicio/getJuegos"
    ajaxhr = $.ajax({
        type: "POST",
        url: uriConsulta,
        cache: false,
        ...
        success: function (result) {
            ...
            if (msj != "") {
                ...
                var datos = result.data;
                $.each(datos, function (index, value) {
                    $("#cboJuego").append('<option value="' + value.Juego + '"  data-id="' + value.Juego + '"  >' + value.Juego + '</option>');
                });
            }
        },
        error: function (request, status, error) {
