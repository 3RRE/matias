$(document).ready(function () {
    ...
    VistaAuditoria("ContadoresNegativos/ConfiguracionAlertaContadorNegativo", "VISTA", 0, "", 3);
    ...
    $(document).on('ifChecked', '#tabContentCargo input', function (event) {
        ...
        $.ajax({
            url: basePath + '/ContadoresNegativos/ContadoresNegativosCargoGuardarJson/',
            ...
            success: function (response) {
                ...
                if (response.respuesta) {
                    ...
                    dataAuditoriaJSON(3, "ContadoresNegativos/ContadoresNegativosCargoGuardarJson", "AGREGAR ALERTA A CARGO EN CONTADORES NEGATIVOS", datainicial, datafinal);
    ...
    $(document).on('ifUnchecked', '#tabContentCargo input', function (event) {
        ...
        $.ajax({
            url: basePath + '/ContadoresNegativos/QuitarContadoresNegativosJson',
            type: 'POST', data: JSON.stringify({ sala_id, alt_id, cargo_id }),
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            beforeSend: function (xhr) {
            ...
            success: function (response) {
                ...
                if (response.respuesta) {
                    ...
                    input.data("alt_id", id);
                    dataAuditoriaJSON(3, "ContadoresNegativos/QuitarContadoresNegativosJson", "QUITAR ALERTA A CARGO EN SALA", datainicial, datafinal);
...
function ListarSalasCargo() {
    var data = {};
    var url = basePath + 'ContadoresNegativos/ContadorNegativoListarJson';
    $.ajax({
        url: url,
        type: "POST",
