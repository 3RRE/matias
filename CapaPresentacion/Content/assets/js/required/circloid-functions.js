...
function circloidBlocks(options){
	...
	function circloidBlockControls(options){
        ...
        $(document).on("click", ".permisosq ul.c_tmtimeline li span.icon", function () {
            console.log("eee", $(this).parent().find(".c_tmlabel_inner ").hasClass("collaps"));
            if ($(this).parent().find(".c_tmlabel_inner").hasClass("collaps")) {

                $(this).parent().find(".c_tmlabel_inner").removeClass("collaps");

            } else {

                $(this).parent().find(".c_tmlabel_inner").addClass("collaps");
